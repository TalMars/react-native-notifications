...
public class PushNotificationProps {
    ...
    public String getChannelId() { return getBundleStringFirstNotNull("channelId", "channelId"); }

    public String getSound() { return getBundleStringFirstNotNull("sound", "sound"); }
